  ...
  <div id="iv3be5" class="gjs-grid-row">
    <div id="ilriti" class="gjs-grid-column">
      ...
      <div id="it6g1v" class="gjs-text-blue">Copyright © YEAR Company name
         ...
         Code cho tôi đoạn code tương tự chỉ cần thẻ <body> không cần thẻ <html> hay <head>. Chỉ trả kết quả là đoạn code trong thẻ <body>, theo format <body>”nội dung”</body> không cần giải thích gì thêm.` + message
      );
  ...
  return (
    <Box className="relative">
      ...
      <Box>
        ...
        {loading && (
          <Box className="w-full h-[calc(100vh-0px)] absolute top-[70px] left-0 flex justify-center items-center z-10 bg-transparent opacity-100">
